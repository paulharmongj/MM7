...
gam_full <- gam(BF~s(Age,bs="ts") + s(Height,bs="ts")+s(Weight_kg,bs="ts") + s(NeckCircumf,bs="ts") + s(ChestCircumf,bs="ts") + s(Abdomen2Circumf,bs="ts")+s(HipCircumf,bs="ts") + s(ThighCircumf,bs="ts") + s(KneeCircumf,bs="ts")+s(AnkleCircumf,bs="ts") + s(ExtendBicepsCircumf,bs="ts") + s(ForearmCircumf,bs="ts") + s(WristCircumf,bs="ts"),data=bf)
